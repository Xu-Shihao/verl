...
# -*- coding: utf-8 -*-
"""
v8 DAPO trainer - 混合RL训练 (binary + multiclass + recommendation)
基于 main_dapo_psy.py，使用 v8 混合奖励函数
"""
...
class TaskRunner:
    def run(self, config):
        ...
        print("=== v8 混合RL DAPO训练 (binary + multiclass + recommendation) ===")
