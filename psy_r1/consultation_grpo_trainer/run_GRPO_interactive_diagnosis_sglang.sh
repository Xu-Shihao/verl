...
MODEL_BASE_NAME="qwen3-8B_interactive_diagnosis_multiturn_ds"
NNODES=1
...
# 长度奖励参数（梯形奖励函数）
USE_LENGTH_REWARD=True  # 是否启用长度奖励
LENGTH_REWARD_WEIGHT=0.2  # 长度奖励权重（建议0.1-0.3）
LENGTH_MIN_TURNS=10  # 最小合理轮数
LENGTH_OPTIMAL_START=15  # 最优区间开始
LENGTH_OPTIMAL_END=25  # 最优区间结束（满分在20-25轮）
LENGTH_MAX_TURNS=50  # 最大合理轮数

# ICD奖励参数
USE_ICD_REWARD=True

# Tool 配置文件路径（使用多轮 tool-call）
TOOL_CONFIG="${HOME}/psy_r1/consultation_grpo_trainer/patient_tool_config.yaml"
