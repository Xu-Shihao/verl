...
EXPERIMENT_NAME="qwen3_8B_symptoms_reasoning_with_symptom_reward_lora_sft_ds-r1_8_gpu"
...
HYDRA_FULL_ERROR=1 && python3 -m psy_r1.verl.trainer.main_ppo_psy \
    ...
    actor_rollout_ref.model.path=/tcci_mnt/shihao/outputs/dataset_v1/qwen3-8B_auxiliary_diagnosis_lora_sft_ds-r1_v4_use_symptoms_true \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=11240 \
