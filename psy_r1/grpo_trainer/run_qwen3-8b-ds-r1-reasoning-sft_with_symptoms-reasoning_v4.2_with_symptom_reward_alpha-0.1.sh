...
MODEL_PATH="/tcci_mnt/shihao/outputs/dataset_v1/qwen3-8B_auxiliary_diagnosis_lora-sft_reasoning_ds-r1_use_symptoms_true_v4.2_lr1e-3"
...
HYDRA_FULL_ERROR=1 && python3 -m psy_r1.verl.trainer.main_ppo_psy \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=18240 \
