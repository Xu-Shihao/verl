...
# 项目配置
project_name='SMHC_ICD_symptom_combined_RL'
exp_name=dapo_${MODEL_BASE_NAME}_icd_symptom_combined_sft_ds-r1_v2_8_gpu
...
# 启动DAPO训练 (使用psy_r1模块，启用ICD+症状组合奖励)
