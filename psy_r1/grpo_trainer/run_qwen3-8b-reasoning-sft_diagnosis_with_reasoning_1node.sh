...
HYDRA_FULL_ERROR=1 && python3 -m psy_r1.verl.trainer.main_ppo_psy \
    ...
    actor_rollout_ref.model.path=/tcci_mnt/shihao/outputs/qwen3-8B_auxiliary_diagnosis_lora_sft_horizon-alpha_v3 \
    ...
    trainer.experiment_name='qwen3_8B_reasoning_lora_sft_horizon-alpha_v3_8_gpu' \
