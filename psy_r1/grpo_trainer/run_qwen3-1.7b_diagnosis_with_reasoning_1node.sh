...
HYDRA_FULL_ERROR=1 && python3 -m psy_r1.verl.trainer.main_ppo_psy \
    ...
    actor_rollout_ref.model.path=/tcci_mnt/shihao/models/Qwen3-1.7B \
    ...
    trainer.project_name='SMHC_diagnosis_with_reasoning' \
    trainer.experiment_name='qwen3_1.7B_8_gpu' \
    ...
    $@ 2>&1 | tee $LOG_DIR/qwen3_1.7B_8_gpu_$NOW.log